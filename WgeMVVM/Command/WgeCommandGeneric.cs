...
{
    public class WgeCommandGeneric<T> : ICommand
    {
        /// <summary>
        ...
        /// [CN]命令要执行的方法
        /// </param>
        public WgeCommandGeneric(Action<T> execute) : this(execute, null)
        {
        }
        ...
        /// [CN]判断命令是否能执行的方法
        /// </param>
        public WgeCommandGeneric(Action<T> execute, Func<T, bool> canExecute)
        {
            _execute = execute;
